...
import { Bot, Twitter, Github } from "lucide-react";
    ...
    <footer className="border-t border-white/10 bg-background/50 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-muted-foreground text-sm max-w-sm">
              The smartest way to build and manage Discord communities. 
              Let AI do the heavy lifting while you focus on growing your server.
            </p>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} AiGuild. All rights reserved.</p>
